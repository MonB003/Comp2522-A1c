 ...
 * @version 1
 */
public class GUIA1a extends JFrame {
    private MainA1a addressBook; // interface to database
     ...
     * 
     * @param people
     *            String[] - records of people (from address book)
     */
    ...
    public void displayMsg(String title, String msg) {
        ...
        // This popup displays a non-error message
